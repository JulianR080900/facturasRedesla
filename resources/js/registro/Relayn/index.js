// ===================== Datos que cambian por cada red ========================
...
$("input[name='tipo_registro']").on("change", function () {
  ...
  if (tipo_registro == "investigación") {
    ...
    Swal.fire({
      title:
        '<p>Está a punto de comenzar su registro como: </p> <p style="color:#FF5100">' +
        tipo_registro.toUpperCase() +
        "</p>",

      imageUrl:
        base_url +
        `/resources/img/registros_redes/Relayn/${year}/investigacion.jpg`,

      imageWidth: 400,

      imageHeight: 300,

      imageAlt: "Información de la investigacion " + year,
    ...
    Swal.fire({
      ...
      imageUrl:
        base_url + `/resources/img/registros_redes/Relayn/${year}/oyente.jpg`,
    ...
    Swal.fire({
      ...
      imageUrl:
        base_url +
        `/resources/img/registros_redes/Relayn/${year}/congreso.jpg`,
    ...
    Swal.fire({
      ...
      imageUrl:
        base_url +
        `/resources/img/registros_redes/Relayn/${year}/coloquio.jpg`,

      imageWidth: 400,

      imageHeight: 300,

      imageAlt: "Información Coloquio " + year,
