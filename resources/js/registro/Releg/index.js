...
$("input[name='tipo_registro']").on("change", function () {
  ...
  if (tipo_registro == "investigación") {
    Swal.fire({
      title:
        '<p>Está a punto de comenzar su registro como: </p> <p style="color:#E95296">' +
        tipo_registro.toUpperCase() +
        "</p>",

      imageUrl:
        base_url +
        `/resources/img/registros_redes/Releg/${year}/investigacion.jpg`,
    ...
    $("#fac_estudio").show("slow").prop("required", true);
    ...
    Swal.fire({
      ...
      imageUrl:
        base_url + `/resources/img/registros_redes/Releg/${year}/oyente.jpg`,
    ...
    $("#fac_estudio").hide().prop("required", false);
    ...
    Swal.fire({
      ...
      imageUrl:
        base_url + `/resources/img/registros_redes/Releg/${year}/congreso.jpg`,

      imageWidth: 400,

      imageHeight: 300,

      imageAlt: "Información Congreso " + year,
