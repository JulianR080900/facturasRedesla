$(document).ready(function () {
  ...
  */
        ...
        var validation = Array.prototype.filter.call(forms, function (form) {
          form.addEventListener(
            ...
            function (event) {
              ...
              let suma_ventas = $("#6g").val();
              if (suma_ventas != 100) {
                swal
                  .fire({
                    title: "La suma de su total de ventas no es 100%.",
                    icon: "warning",
                  })
                  .then(function () {
                    $("fieldset").css({
              ...
              let suma_egresos = $("#6p").val();
              if (suma_egresos != 100) {
                swal
                  .fire({
                    title: "La suma de sus egresos de ventas no es 100%",
                    icon: "warning",
                  })
                  .then(function () {
                    $("fieldset").css({
              ...
              if (
                $("input[name='9a']:checked").val() == "nc" &&
                $("input[name='9b']:checked").val() == "nc" &&
                $("input[name='9c']:checked").val() == "nc" &&
                $("input[name='9d']:checked").val() == "nc" &&
                $("input[name='9e']:checked").val() == "nc" &&
                $("input[name='10a']:checked").val() == "nc" &&
                $("input[name='10b']:checked").val() == "nc" &&
                $("input[name='10c']:checked").val() == "nc" &&
                $("input[name='10d']:checked").val() == "nc" &&
                $("input[name='10e']:checked").val() == "nc" &&
                $("input[name='11a']:checked").val() == "nc" &&
                $("input[name='11b']:checked").val() == "nc" &&
                $("input[name='11c']:checked").val() == "nc" &&
                $("input[name='11d']:checked").val() == "nc" &&
                $("input[name='11e']:checked").val() == "nc" &&
                $("input[name='12a']:checked").val() == "nc" &&
                $("input[name='12b']:checked").val() == "nc" &&
                $("input[name='12c']:checked").val() == "nc" &&
                $("input[name='12d']:checked").val() == "nc" &&
                $("input[name='12e']:checked").val() == "nc" &&
                $("input[name='13a']:checked").val() == "nc" &&
                $("input[name='13b']:checked").val() == "nc" &&
                $("input[name='13c']:checked").val() == "nc" &&
                $("input[name='13d']:checked").val() == "nc" &&
                $("input[name='13e']:checked").val() == "nc" &&
                $("input[name='14a']:checked").val() == "nc" &&
                $("input[name='14b']:checked").val() == "nc" &&
                $("input[name='14c']:checked").val() == "nc" &&
                $("input[name='14d']:checked").val() == "nc" &&
                $("input[name='14e']:checked").val() == "nc" &&
                $("input[name='15a']:checked").val() == "nc" &&
                $("input[name='15b']:checked").val() == "nc" &&
                $("input[name='15c']:checked").val() == "nc" &&
                $("input[name='15d']:checked").val() == "nc" &&
                $("input[name='15e']:checked").val() == "nc" &&
                $("input[name='16a']:checked").val() == "nc" &&
                $("input[name='16b']:checked").val() == "nc" &&
                $("input[name='16c']:checked").val() == "nc" &&
                $("input[name='16d']:checked").val() == "nc" &&
                $("input[name='16e']:checked").val() == "nc" &&
                $("input[name='17a']:checked").val() == "nc" &&
                $("input[name='17b']:checked").val() == "nc" &&
                $("input[name='17c']:checked").val() == "nc" &&
                $("input[name='17d']:checked").val() == "nc" &&
                $("input[name='17e']:checked").val() == "nc" &&
                $("input[name='18a']:checked").val() == "nc" &&
                $("input[name='18b']:checked").val() == "nc" &&
                $("input[name='18c']:checked").val() == "nc" &&
                $("input[name='18d']:checked").val() == "nc" &&
                $("input[name='18e']:checked").val() == "nc" &&
                $("input[name='19a']:checked").val() == "nc" &&
                $("input[name='19b']:checked").val() == "nc" &&
                $("input[name='19c']:checked").val() == "nc" &&
                $("input[name='19d']:checked").val() == "nc" &&
                $("input[name='19e']:checked").val() == "nc" &&
                $("input[name='20a']:checked").val() == "nc" &&
                $("input[name='20b']:checked").val() == "nc" &&
                $("input[name='20c']:checked").val() == "nc" &&
                $("input[name='20d']:checked").val() == "nc" &&
                $("input[name='20e']:checked").val() == "nc" &&
                $("input[name='20f']:checked").val() == "nc" &&
                $("input[name='21a']:checked").val() == "nc" &&
                $("input[name='21b']:checked").val() == "nc" &&
                $("input[name='21c']:checked").val() == "nc" &&
                $("input[name='21d']:checked").val() == "nc" &&
                $("input[name='21e']:checked").val() == "nc" &&
                $("input[name='22a']:checked").val() == "nc" &&
                $("input[name='22b']:checked").val() == "nc" &&
                $("input[name='22c']:checked").val() == "nc" &&
                $("input[name='22d']:checked").val() == "nc" &&
                $("input[name='22e']:checked").val() == "nc" &&
                $("input[name='22f']:checked").val() == "nc" &&
                $("input[name='22g']:checked").val() == "nc" &&
                $("input[name='22h']:checked").val() == "nc" &&
                $("input[name='22i']:checked").val() == "nc" &&
                $("input[name='22j']:checked").val() == "nc" &&
                $("input[name='22k']:checked").val() == "nc" &&
                $("input[name='22l']:checked").val() == "nc" &&
                $("input[name='22m']:checked").val() == "nc" &&
                $("input[name='22n']:checked").val() == "nc" &&
                $("input[name='22o']:checked").val() == "nc" &&
                $("input[name='22p']:checked").val() == "nc" &&
                $("input[name='22q']:checked").val() == "nc" &&
                $("input[name='23a']:checked").val() == "nc" &&
                $("input[name='23b']:checked").val() == "nc" &&
                $("input[name='23c']:checked").val() == "nc" &&
                $("input[name='23d']:checked").val() == "nc" &&
                $("input[name='23e']:checked").val() == "nc" &&
                $("input[name='23f']:checked").val() == "nc" &&
                $("input[name='23g']:checked").val() == "nc" &&
                $("input[name='23h']:checked").val() == "nc" &&
                $("input[name='23i']:checked").val() == "nc" &&
                $("input[name='23j']:checked").val() == "nc" &&
                $("input[name='24a']:checked").val() == "nc" &&
                $("input[name='24b']:checked").val() == "nc" &&
                $("input[name='24c']:checked").val() == "nc" &&
                $("input[name='24d']:checked").val() == "nc" &&
                $("input[name='24e']:checked").val() == "nc" &&
                $("input[name='24f']:checked").val() == "nc" &&
                $("input[name='24g']:checked").val() == "nc" &&
                $("input[name='24h']:checked").val() == "nc" &&
                $("input[name='24i']:checked").val() == "nc" &&
                $("input[name='24j']:checked").val() == "nc" &&
                $("input[name='25a']:checked").val() == "nc" &&
                $("input[name='25b']:checked").val() == "nc" &&
                $("input[name='25c']:checked").val() == "nc" &&
                $("input[name='25d']:checked").val() == "nc" &&
                $("input[name='25e']:checked").val() == "nc" &&
                $("input[name='25f']:checked").val() == "nc" &&
                $("input[name='25g']:checked").val() == "nc" &&
                $("input[name='25h']:checked").val() == "nc" &&
                $("input[name='25i']:checked").val() == "nc" &&
                $("input[name='25j']:checked").val() == "nc" &&
                $("input[name='26a']:checked").val() == "nc" &&
                $("input[name='26b']:checked").val() == "nc" &&
                $("input[name='26c']:checked").val() == "nc" &&
                $("input[name='26d']:checked").val() == "nc" &&
                $("input[name='26e']:checked").val() == "nc" &&
                $("input[name='26f']:checked").val() == "nc" &&
                $("input[name='26g']:checked").val() == "nc" &&
                $("input[name='26h']:checked").val() == "nc" &&
                $("input[name='26i']:checked").val() == "nc" &&
                $("input[name='26j']:checked").val() == "nc" &&
                $("input[name='27a']:checked").val() == "nc" &&
                $("input[name='27b']:checked").val() == "nc" &&
                $("input[name='27c']:checked").val() == "nc" &&
                $("input[name='27d']:checked").val() == "nc" &&
                $("input[name='27e']:checked").val() == "nc" &&
                $("input[name='27f']:checked").val() == "nc" &&
                $("input[name='27g']:checked").val() == "nc" &&
                $("input[name='27h']:checked").val() == "nc" &&
                $("input[name='27i']:checked").val() == "nc" &&
                $("input[name='27j']:checked").val() == "nc" &&
                $("input[name='28a']:checked").val() == "nc" &&
                $("input[name='28b']:checked").val() == "nc" &&
                $("input[name='28c']:checked").val() == "nc" &&
                $("input[name='28d']:checked").val() == "nc" &&
                $("input[name='28e']:checked").val() == "nc" &&
                $("input[name='28f']:checked").val() == "nc" &&
                $("input[name='28g']:checked").val() == "nc" &&
                $("input[name='28h']:checked").val() == "nc" &&
                $("input[name='28i']:checked").val() == "nc" &&
                $("input[name='28j']:checked").val() == "nc"
              ) {
                swal
                  .fire({
                    title: "Conteste correctamente el formulario",
                    icon: "warning",
                  })
                  .then(function () {
                    $("fieldset").css({
              ...
              if (form.checkValidity() === false) {
                ...
                swal
                  .fire({
                    title:
                      "Asegúrese que TODAS las preguntas tengan una respuesta seleccionada sobre todo en los apartados 3, 4, 5 y 6. Recuerde que CADA PREGUNTA debe tener una respuesta VÁLIDA para poder FINALIZAR.",
                    icon: "warning",
                  })
                  .then(function () {
  ...
  $("#ejemplo_descripcion_ubicacion").on("click", function () {
    Swal.fire({
      ...
      imageUrl: base_url + "/resources/img/investigaciones/ejemplos/descripcion_negocio.jpg",
      imageWidth: 780,
      imageHeight: 600,
      imageAlt: "Custom image",
      customClass: "swal-wide",
  ...
  $("#ejemplo_vialidad_1").on("click", function () {
    Swal.fire({
      imageUrl: base_url + "/resources/img/investigaciones/ejemplos/direccion_1.jpg",
      imageWidth: 780,
      imageHeight: 600,
      imageAlt: "Custom image",
      customClass: "swal-wide",
  ...
  $("#ejemplo_vialidad_2").on("click", function () {
    Swal.fire({
      imageUrl: base_url + "/resources/img/investigaciones/ejemplos/direccion_2.jpg",
      imageWidth: 780,
      imageHeight: 600,
      imageAlt: "Custom image",
      customClass: "swal-wide",
  ...
  */
  ...
  $('#inputRFC, #inputNIT, #1h, #1g, #nombre_conglomerado, #nombre_vialidad_1, #nombre_vialidad_2, #nombre_vialidad_posterior, #nombre_ubicacion_empresa,#otro_piso_input, #descripcion_mype').on("keypress", function (event) {
    /*Nombres con acentos*/
  ...
  $('#inputRIT').on("keypress", function (event) {
    /*Nombres con acentos*/
  ...
  $("#inputRIT").on("keyup", function () {
    let val = $(this).val();
    var nitRegExp = /^\d{9,10}-(\d{1}|[kK])$/;
    
    if (nitRegExp.test(val)) {
      $("#valid_nit").hide().removeClass("text-danger").text("");
      // aquí podrías hacer algo si el NIT es válido
    } else {
      $("#valid_nit")
        .show()
        .addClass("text-danger")
        .text("Ingrese un valor válido.");
      // aquí podrías hacer algo si el NIT no es válido
    }
  });
  ...
  $("#tipo_vialidad_posterior").on('change',function(){
    let val = $(this).val()
    if(val == 'na'){
      $("#nombre_vialidad_posterior").val('No aplica.').prop('readonly',true);
    }else{
  ...
  $("#tipo_conglomerado").on('change',function(){
    let val = $(this).val()
    if(val == 'na'){
      $("#nombre_conglomerado").val('No aplica.').prop('readonly',true);
    }else{
  ...
  $("#tel_fijo,#tel_extension,#tel_cel").on('keyup',function(){
    ...
    if(id == 'tel_extension'){
      if(val.length < 1){
        ...
        $("#valid_" + id).hide().removeClass("text-danger").text("");
      }
    }else{
      if(val.length < 10){
        $("#valid_" + id)
  ...
  $("#localidad").on('change',function(){
    let nombre_localidad = $(this).val()
    let municipio = $("#clave_municipio").val()
    let estado = $("#clave_estado").val()
    $.ajax({
      type: "POST",
      url: "../getClaveLocalidad",
      data: {
