...
<body>
    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <img src="<?= base_url("resources/img/logos_con_letras/Letras_Releg.png") ?>" style="width:200px">
        ...
        <h4 class='text-center'>En este apartado se editara la entrevista # <?= $_SESSION["id_recapturar"] ?>. </h4>
    ...
    <form class="row g-3 needs-validation" novalidate method="post" action="<?= base_url("actRecapturarEntrevista") ?>">
        ...
        <section id="primeraSeccion">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nombre_entrevistadora" id="nombre_entrevistadora" required value="<?= $data['nombre_entrevistadora'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="lugar_entrevista" id="lugar_entrevista" required value="<?= $data['lugar_entrevista'] ?>">
                ...
                <div class"row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="time" class="form-control" name="hora_aplicacion_inicio" id="hora_aplicacion_inicio" required value="<?= $data['hora_aplicacion_inicio'] ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="time" class="form-control" name="hora_aplicacion_final" id="hora_aplicacion_final" required value="<?= $data['hora_aplicacion_final'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="fecha_entrevista" id="fecha_entrevista" required value="<?= $data['fecha_entrevista'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control without_ampm" name="duracion_entrevista" id="duracion_entrevista" required readonly value="<?= $data['duracion_entrevista'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre_entrevistada" name="nombre_entrevistada" aria-describedby="infoHelp" value="<?= $data['nombre_entrevistada'] ?>">
            ...
            <div class="mb-3">
                ...
                <div class="input-group has-validation">
                    ...
                    <input type="number" class="form-control" id="pregunta1" name="pregunta1" required value="<?= $data['pregunta1'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pregunta2" name="pregunta2" required value="<?= $data['pregunta2'] ?>">
            ...
            <div class="mb-3">
                ...
                <select id="pregunta3" class="form-control" required name="pregunta3">
                    ...
                    <option value="si" <?= $data['pregunta3'] == "si" ? 'selected' : ''; ?>>Sí</option>

                    <option value="no" <?= $data['pregunta3'] == "no" ? 'selected' : ''; ?>>No</option>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pregunta5" name="pregunta5" aria-describedby="pregunta5" required value="<?= $data['pregunta5'] ?>">
            ...
            <div class="mb-3">
                ...
                <select id="pregunta6" name="pregunta6" class="form-select" required>
                    ...
                    <option value="TSU" <?= $data['pregunta6'] == "TSU" ? 'selected' : ''; ?>>TSU</option>

                    <option value="Licenciatura" <?= $data['pregunta6'] == "Licenciatura" ? 'selected' : ''; ?>>Licenciatura</option>

                    <option value="Maestría" <?= $data['pregunta6'] == "Maestría" ? 'selected' : ''; ?>>Maestría</option>

                    <option value="Doctorado" <?= $data['pregunta6'] == "Doctorado" ? 'selected' : ''; ?>>Doctorado</option>

                    <option value="Posgrado" <?= $data['pregunta6'] == "Posgrado" ? 'selected' : ''; ?>>Posgrado</option>
            ...
            <div class="mb-3">
                ...
                <select id="pregunta7" name="pregunta7" class="form-select" required>
                    ...
                    <option value="Anual" <?= $data['pregunta7'] == "Anual" ? 'selected' : ''; ?>>Anual</option>

                    <option value="Semestral" <?= $data['pregunta7'] == "Semestral" ? 'selected' : ''; ?>>Semestral</option>

                    <option value="Mensual" <?= $data['pregunta7'] == "Mensual" ? 'selected' : ''; ?>>Mensual (cada materia dura un mes)</option>

                    <option value="Libre avance" <?= $data['pregunta7'] == "Libre avance" ? 'selected' : ''; ?>>Libre avance</option>

                    <option value="otro" <?= $data['pregunta7'] == "otro" ? 'selected' : ''; ?>>Otro</option>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pregunta8" name="pregunta8" aria-describedby="pregunta8" value="<?= $data['pregunta8'] ?>" required onkeypress="return soloNA(event)">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pregunta9" name="pregunta9" aria-describedby="pregunta9" value="<?= $data['pregunta9'] ?>" required>
            ...
            <div class="mb-3">
                ...
                <select id="pregunta10" name="pregunta10" class="form-control" required>
                    ...
                    ?>
                        ...
                        <option value="<?php echo $estado["id"] ?>" <?= $data['pregunta10'] == $estado['id'] ? 'selected' : ''; ?>><?php echo $estado["nombre"] ?></option>
            ...
            <div class="mb-3">
                ...
                <select id="pregunta12" name="pregunta12" class="form-control" required>
                    ...
                    <option value="público" <?= $data['pregunta12'] == "público" ? 'selected' : ''; ?>>Pública</option>

                    <option value="privado" <?= $data['pregunta12'] == "privado" ? 'selected' : ''; ?>>Privada</option>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="pregunta13" name="pregunta13" aria-describedby="pregunta13" required value="<?= $data['pregunta13'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="pregunta14" name="pregunta14" required value="<?= $data['pregunta14'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="pregunta15" name="pregunta15" required value="<?= $data['pregunta15'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="pregunta16" name="pregunta16" required value="<?= $data['pregunta16'] ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="pregunta17" name="pregunta17" aria-describedby="pregunta17" required value="<?= $data['pregunta17'] ?>">
            ...
            <div class="mb-3">
                ...
                <select id="pregunta18" name="pregunta18" class="form-control" required>
                    ...
                    <option value="física" <?= $data['pregunta18'] == "física" ? 'selected' : ''; ?>>Física</option>

                    <option value="virtual" <?= $data['pregunta18'] == "virtual" ? 'selected' : ''; ?>>Virtual</option>

                    <option value="mixta" <?= $data['pregunta18'] == "mixta" ? 'selected' : ''; ?>>Mixta</option>
            ...
            <div class="mb-3">
                ...
                <select id="pregunta19" name="pregunta19" class="form-control" required>
                    ...
                    <option value="si" <?= $data['pregunta19'] == "si" ? 'selected' : ''; ?>>Sí</option>

                    <!--depende si es si o no se mostraran las siguientes preguntas-->

                    <option value="no" <?= $data['pregunta19'] == "no" ? 'selected' : ''; ?>>No</option>
        ...
        <section id="bitacoraSection">
            ...
            <div class="mb-3">
                ...
                <textarea type="text" rows="20" class="form-control" name="bitacora" id="bitacora" required><?= $bitacora; ?></textarea>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            if ($("#pregunta7").val() == 'otro') {

                $("#otro_ciclo").show();

                $("#pregunta7_5").prop("required", true);

                $("#pregunta7_5").val('<?= $data['pregunta7_5']; ?>');
            ...
            $.ajax({
                ...
                url: base_url + '/getMunicipioID/' + <?= $data['pregunta11'] ?>,

                data: {

                    'estado': <?= $data['pregunta10'] ?>
            ...
            if ($("#pregunta19").val() == "si") {
                ...
                $("#pregunta20").val('<?= preg_replace("/[\r\n|\n|\r]+/", " ", $data['pregunta20']) ?>');

                $("#pregunta21").val('<?= preg_replace("/[\r\n|\n|\r]+/", " ", $data['pregunta21']) ?>');

                $("#pregunta22").val('<?= preg_replace("/[\r\n|\n|\r]+/", " ", $data['pregunta22']) ?>');

                $("#pregunta23").val('<?= preg_replace("/[\r\n|\n|\r]+/", " ", $data['pregunta23']) ?>');

                $("#pregunta24").val('<?= preg_replace("/[\r\n|\n|\r]+/", " ", $data['pregunta24']) ?>');

                $("#pregunta25").val('<?= preg_replace("/[\r\n|\n|\r]+/", " ", $data['pregunta25']) ?>');
