                ...
                <div class="col align-self-center">
                    <form id="msform" method="post" action="./actualizar" class="needs-validation" novalidate data-toggle="validator">
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                <label for="">1d) ¿La empresa cuenta con SUNAT (Superintendencia Nacional de Aduanas y de Administración Tributaria)?</label>
                                <br>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="inlineRadio2">No aplica SUNAT</label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <br>
                                ...
                                ?>
                                    <div>
                                        <label for="">Escriba su SUNAT.</label>
                                    ...
                                    <div>
                                        <label for="">¿El SUNAT es personal o de la empresa?</label>
                            ...
                            <div>
                                <label for="">1r) Departamento (Información obtenida de los datos que registró en la plataforma <a target="_blank" href="<?= base_url() ?>">REDESLA</a>)</label>
                            ...
                            <div>
                                <label for="">1s) Distrito (Información obtenida de los datos que registró en la plataforma <a target="_blank" href="<?= base_url() ?>">REDESLA</a>) </label>
                            ...
                            <div>
                                <label for="">1aa) Tipo de negocio.</label>
                            ...
                            <div>
                                <label for="">
                                1ab) Se realizó la equivalencia entre el catálogo de clasificación de los sectores empleada por la RELAYN y el Instituto Nacional de Estadística.
                                </label>
