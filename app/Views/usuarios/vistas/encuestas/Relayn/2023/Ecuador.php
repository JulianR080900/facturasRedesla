...
<body>
    ...
    <style>
        ...
        /*Color text of the step and the connector before it*/
...
<div class="container">
        ...
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <div class="col align-self-center">
                    <form id="msform" method="post" class="needs-validation" novalidate data-toggle="validator">
                        <!-- progressbar -->
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <input type="text" name="1b" id="1b" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                <label for="">1d) ¿La empresa cuenta con RUC (Registro Único de Contribuyentes)?</label>
                                <br>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="inlineRadio2">No aplica RUC</label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <br>
                                ...
                                ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="tipo_rfc" id="tipo_rfc" class="form-control">
                                    </div>
                                <?php
                                } else {
                                ?>
                                    <div>
                                        <label for="">Escriba su RUC.</label>
                                        ...
                                        <p id="valid_nit"></p>
                                        <div class="invalid-feedback">
                                            El RUC son al menos 13 catácteres.
                                        </div>
                                    </div>
                                    <div>
                                        <label for="">¿El RUC es personal o de la empresa?</label>
                                        <input type="text" name="tipo_nit" id="tipo_nit" class="form-control">
                                    </div>
                                <?php
                                }
                                ?>
                            ...
                            <div>
                                <label for="">1f) Tipo de parroquia donde se ubica la empresa.</label>
                                <input type="text" name="1e" id="1e" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                <label for="">1g) Nombre de la parroquia donde se ubica la empresa.</label>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="check_1f">
                                        No aplica nombre de la parroquia.
                                    </label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                            ...
                            <div>
                                ...
                                <input type="text" name="1i" id="1i" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="info_cp" id="info_cp" class="form-control">
                            </div>
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="tipo_conglomerado" id="tipo_conglomerado" class="form-control">
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div>
                                <label for="">1m) Tipo y nombre de las parroquia entre las que se ubica la empresa (para registrar las parroquia debe posicionarse dando la espalda a la
                                    puerta de acceso principal de la empresa. La parroquia 1 será ubicada en el costado derecho; la parroquia 2 será ubicada en el costado izquierdo;
                                    la parroquia posterior será la ubicada a su espalda).</label>
                                <p>
                                ...
                                <div class="row">
                                    <div class="col md-4">
                                        <label for="">Tipo de parroquia 1</label>
                                        <input type="text" name="tipo_vialidad_1" id="tipo_vialidad_1" class="form-control">
                                    </div>
                                    <div class="col-md-8">
                                        <label for="">Nombre de la parroquia 1</label>
                                ...
                                <div class="row">
                                    <div class="col md-4">
                                        <label for="">Tipo de parroquia 2</label>
                                        <input type="text" name="tipo_vialidad_2" id="tipo_vialidad_2" class="form-control">
                                    </div>
                                    <div class="col-md-8">
                                        <label for="">Nombre de la parroquia 2</label>
                                ...
                                <div class="row">
                                    <div class="col md-4">
                                        <label for="">Tipo de parroquia posterior</label>
                                        <input type="text" name="tipo_vialidad_posterior" id="tipo_vialidad_posterior" class="form-control">
                                    </div>
                                    <div class="col-md-8">
                                        <label for="">Nombre de la parroquia posterior</label>
                            ...
                            <div>
                                ...
                                <input type="text" name="piso_empresa" id="piso_empresa" class="form-control">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="descripcion_mype" id="descripcion_mype" class="form-control" cols="30" rows="5" required></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="1l" id="1l" class='form-control' readonly>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="estado_pais" id="estado_pais" class="form-control" readonly value="<?= $estado ?>">
                            </div>

                            <!-- CAMPO AUTORELLENABLE -->
                            <div>
                                <label for="">Clave de estado</label>
                                <p class="text-primary" style="font-size: 11px;">Campo autocompletado automáticamente.</p>
                                <input type="text" name="clave_estado" id="clave_estado" class="form-control" readonly value="<?= $clave_estado ?>">
                            </div>

                            <div>
                                <label for="">1s) Cantón (Información obtenida de los datos que registró en la plataforma <a target="_blank" href="<?= base_url() ?>">REDESLA</a>) </label>
                                <input type="text" name="1k" id="1k" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                <label for="">1t) Clave de su municipio</label>
                                <p class="text-primary" style="font-size: 11px;">Este campo se autocompletará al seleccionar su municipio.</p>
                                <input type="text" name="clave_municipio" id="clave_municipio" class="form-control" readonly value="<?= $clave_municipio ?>">
                            </div>



                            <div>
                                <label for="">1u) Enlace de <a href="https://www.google.com/maps" target="_blank">Google Maps</a> con la ubicación física de la empresa.</label>
                            ...
                            <div>
                                <label for="">1v) Tipo de comercio.</label>
                                <input type="text" name="tipo_comercio" id="tipo_comercio" class="form-control">
                            </div>

                            <div>
                                <label for="">1w) Facebook de la empresa.</label>
                            ...
                            <div>
                                <label for="">1x) Correo electrónico de la empresa.</label>
                            ...
                            <div>
                                <label for="">1y) Página de internet de la empresa.</label>
                            ...
                            <div>
                                <label for="">1z) Twitter de la empresa.</label>
                            ...
                            <div>
                                <label for="">1aa) Giro del negocio.</label>
                                <input type="text" name="1q" id="1q" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div>
                                <label for="">
                                1ab) Se realizó la equivalencia entre el catálogo de clasificación de los sectores empleada por
                                la RELAYN y el clasificador oficial que utiliza el INEGI (Sistema de Clasificación Industrial de América del Norte SCIAN 2018) en México.
                                </label>

                                <input type="text" name="1r" id="1r" required class="form-control">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="2a" id="2a" min="1800" max="2023" required pattern="^[0-9]{4,}$">
                            ...
                            <div>
                                ...
                                <input type="text" name="2b" id="2b" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="2c" id="2c" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="2d" id="2d" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="2e" id="2e" class="form-control">
                            ...
                            <div>
                                ...
                                <input type="text" name="2f" id="2f" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="2g" id="2g" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="2h" id="2h" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                <label for="">2j) Indique los tres principales productos y/o servicios que fabricó y ofreció el negocio durante el año 2022 (colocar al menos 1).</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="3a" id="mujeres" required>
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="3b" id="hombres" required>
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="3c" id="total1" required readonly>
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="3d" id="familiares" required>
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="3e" id="no_familiares" required>
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="">Total</label>
                                    <input type="text" class="form-control" name="3f" id="total2" required readonly>
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                            ...
                            <h4>4) ¿Cuál es el nivel de estudios de sus trabajadores?</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4a1" id="4a1" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4a2" id="4a2" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4aa1" id="4aa1" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4aa2" id="4aa2" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4b1" id="4b1" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4b2" id="4b2" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4c1" id="4c1" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4c2" id="4c2" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4d1" id="4d1" required><br>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="4d2" id="4d2" required>
                                        <div class="col-md-4">
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="4total" id="4total" class="form-control" readonly>
                                        <p id="total4"></p>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <input type="text" name="5b" id="5b" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>

                                <label for="">5c) Bonos o prima de servicios</label>
                                <input type="text" name="5c" id="5c" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>

                                <label for="">5d) Participación de las utilidades a los trabajadores</label>
                                <input type="text" name="5d" id="5d" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>

                                <label for="">5e) Capacitación formal</label>
                                <input type="text" name="5e" id="5e" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>

                                <label for="">5f) Vacaciones pagadas</label>
                                <input type="text" name="5f" id="5f" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6d" id="6d" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6e" id="6e" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6f" id="6f" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td class="bg-warning">
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6g" id="6g" class="form-control" min='0' max='100' required readonly>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6h" id="6h" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6i" id="6i" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6j" id="6j" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6k" id="6k" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6l" id="6l" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6m" id="6m" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6n" id="6n" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                <td>6n) Egreso - Impuestos (IVA, ISD, reparto de utilidades, etc.)</td>
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6o" id="6o" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td class="bg-warning">
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6p" id="6p" class="form-control" min='0' max='100' required readonly>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td class="bg-success">
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="6q" id="6q" class="form-control" min='0' max='100' required onkeyup="countPorcentaje(event)">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon2">%</span>
                                                        </div>
                                                        <div class="invalid-feedback">
                        ...
                        <fieldset id="field2">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="7b" id="7b" min="18" max="130" required>
                                <p id="valid_edad"></p>
                                <div class="invalid-feedback">
                            ...
                            <div>
                                ...
                                <input type="text" name="7c" id="7c" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="7d" id="7d" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="7e" id="7e" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="7f" id="7f" class="form-control">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="8a" id="8a" min="1" max="7" class="form-control" required>
                                    <p id="valid_dias"></p>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="8b" id="8b" class="form-control">
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="8c" id="8c" class="form-control">
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="8d" id="8d" class="form-control">
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="8e" id="8e" class="form-control">
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="8f" id="8f" class="form-control">
                                    <div class="invalid-feedback">
                                        Complete este campo.
                                    </div>
                                </div>
                        ...
                        <fieldset id="field6">
                            ...
                            <input type="text" name="id_actualizar" id="id_actualizar" hidden>
                            <input type="text" name="tabla" id="tabla" hidden>
                            <input type="button" name="previous" class="previous btn btn-block btn-danger" value="Regresar" />
                        </fieldset>
    ...
    <script src="<?= base_url('resources/js/cuestionarios/Relayn/2023/vistaEditable.js') ?>"></script>
    ...
    <script>
        ...
        let id_cuestionario = '<?= $cuestionario['id'] ?>'
        let nombre_tabla = '<?= $tabla ?>'
        const formObj = <?= json_encode($cuestionario) ?>
        
        let claveEstado = '<?= $clave_estado ?>'
        let claveMunicipio = '<?= $clave_municipio ?>'
        let nombreEstado = '<?= $estado ?>'
        let pais = '<?= $pais ?>'

        $("#info_cp").append('<?= $info_cp ?>')
        ...
        Object.values(radios).forEach(val => {
            ...
            if (value == formObj[name]) {
                $("input:radio[name='" + name + "']").filter('[value="' + value + '"]').prop('checked', true).addClass('changeColorRadio');
            }
        });
        ...
        'estado_pais','clave_municipio','clave_estado','info_cp','otra_info_cp','tipo_vialidad_posterior','clave_loc'];

        const selects = ['tipo_conglomerado','tipo_vialidad_1','tipo_vialidad_2','piso_empresa','info_cp','tipo_vialidad_posterior','nombre_localidad']
        ...
        if(pais == 2){
            if(vacios > 2){
                //SIGNIFICA QUE TIENE DERECHO A EDITAR
                accesoEditar()
            }else if($("#clave_loc").val() == 'Sin respuesta.'){
                accesoEditarLocalidad()
            }else{
                sinAcceso()
            }
        }else{
            sinAccesoExtranjeros()
        }
        ...
        function accesoEditar(){
            ...
            $("#estado_pais").val(nombreEstado)
            $("#clave_estado").val(claveEstado)
            $("#clave_municipio").val(claveMunicipio)
        }
        ...
        function sinAcceso(){
            Object.values(selects).forEach(s => {
                ...
                let html = '<input type="text" class="form-control" name="'+s+'" id="'+s+'" value="'+value+'" disabled>'
                $("#"+s).remove()
                parent.append(html)
            })

            if($("#info_cp").val() == 'otra'){
                $("#otra_ubi").addClass('importantDisplay');;
            }

            $("#descripcion_mype").text(formObj['descripcion_mype']).prop('disabled',true)
            $("button[type='submit']").remove()
            $("form").attr('action','')
        }

        function sinAccesoExtranjeros(){
            Object.values(selects).forEach(s => {
                value = formObj[s];
                const parent = $('#'+s).parent()
                let html = '<input type="text" class="form-control" name="'+s+'" id="'+s+'" value="'+value+'" disabled>'
        ...
        function accesoEditarLocalidad(){
            selects.pop()
            Object.values(editables).forEach(e => {
                let name = e
                if(selects.includes(name)){
            ...
            $("#clave_loc").prop('disabled',false);
            $("#descripcion_mype").text(formObj['descripcion_mype']).prop('disabled',true)
            $('select[name="nombre_localidad"]').prop('disabled',false)
        }




        $("#id_actualizar").prop('disabled',false).val(id_cuestionario)
        $("#tabla").prop('disabled',false).val(nombre_tabla)
    </script>
</body>
