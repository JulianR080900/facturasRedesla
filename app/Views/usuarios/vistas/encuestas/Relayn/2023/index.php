        ...
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <div class="col align-self-center">
                    <form id="msform" method="post" action="./actualizar" class="needs-validation" novalidate data-toggle="validator">
                        <!-- progressbar -->
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="tel_fijo" id="tel_fijo" class="form-control" minlength="10" maxlength="10" placeholder="10 dígitos sin espacios.">
                                        <div class="form-check">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="tel_extension" id="tel_extension" class="form-control" minlength="1" maxlength="4" placeholder="De 1 a 4 dígitos sin espacios.">
                                        <div class="form-check">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="tel_cel" id="tel_cel" class="form-control" minlength="10" maxlength="10" placeholder="10 dígitos sin espacios.">
                                        <div class="form-check">
                            ...
                            <div>
                                ...
                                <select name="info_cp" id="info_cp"  class="form-control">
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select name="tipo_conglomerado" id="tipo_conglomerado" class="form-control">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="nombre_conglomerado" id="nombre_conglomerado" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col md-4">
                                        ...
                                        <select name="tipo_vialidad_1" id="tipo_vialidad_1" class="form-control">
                                            <option value="" selected disabled>Seleccione una opción</option>
                                            <?php
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="nombre_vialidad_1" id="nombre_vialidad_1" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col md-4">
                                        ...
                                        <select name="tipo_vialidad_2" id="tipo_vialidad_2" class="form-control">
                                            <option value="" selected disabled>Seleccione una opción</option>
                                            <?php
                                            foreach ($vialidades as $v) {
                                            ?>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="nombre_vialidad_2" id="nombre_vialidad_2" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col md-4">
                                        ...
                                        <select name="tipo_vialidad_posterior" id="tipo_vialidad_posterior" class="form-control">
                                            <option value="" selected disabled>Seleccione una opción</option>
                                            <?php
                                            foreach ($vialidades as $v) {
                                            ?>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="nombre_vialidad_posterior" id="nombre_vialidad_posterior" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre_ubicacion_empresa" id="nombre_ubicacion_empresa" class="form-control">
                                <div class="form-check">
                            ...
                            <div>
                                ...
                                <select name="piso_empresa" id="piso_empresa" class="form-control">
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <?php
                                    foreach ($pisos as $p) {
                                    ?>
                            ...
                            <div>
                                ...
                                <textarea name="descripcion_mype" id="descripcion_mype" class="form-control" cols="30" rows="5"></textarea>
                            </div>
                            ...
                            <div>
                                <label for="">1s) Municipio (Información obtenida de los datos que registró en la plataforma <a target="_blank" href="<?= base_url() ?>">REDESLA</a>) </label>
                            ...
                            <div>
                                <label for="">Seleccione su localidad</label>
                                <select name="nombre_localidad" id="nombre_localidad" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción.</option>
                                    <?php
                                    foreach($localidades as $l){
                                        ?>
                                        <option value="<?= $l['clave_localidad'] ?>"><?= $l['nombre_localidad'] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <div>
                                <label for="">Clave de la localidad</label>
                                <p class="text-primary" style="font-size: 11px;">Este campo se autocompletará al seleccionar su localidad.</p>
    ...
    <script>
        ...
        function sinAccesoExtranjeros(){
            Object.values(editables).forEach(e => {
                ...
                let html = '<h5 class="text-danger">Sin acceso por el país de origen.</h5>';
                parent.append(html)
                $("#"+e).remove()
            })
            $("button[type='submit']").remove()
        ...
        $("#nombre_localidad").on('change',function(){
            let val = $(this).val()
            $("#clave_loc").val(val)            
        });
