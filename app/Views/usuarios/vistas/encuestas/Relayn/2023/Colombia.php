                ...
                <div class="col align-self-center">
                    <form id="msform" method="post" action="../agregar" class="needs-validation" novalidate data-toggle="validator">
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                <label for="">1d) ¿La empresa cuenta con RIT (Registro de Información Tributaria)?</label>
                                <br>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="inlineRadio2">No aplica RIT</label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div id="rfcnit">
                                    <div>
                                        <label for="">Escriba su RIT.</label>
                                    ...
                                    <div>
                                        <label for="">¿El RIT es personal o de la empresa?</label>
                            ...
                            <div>
                                <label for="">1f) Tipo de ubicación de la empresa.</label>
                            ...
                            <div>
                                <label for="">1g) Nombre de la localidad/municipio donde se ubica la empresa.</label>
                            ...
                            <div>
                                <label for="">1j) Uso de suelo donde se ubica la empresa.</label>
                            ...
                            <div>
                                ...
                                <input type="text" name="estado_pais" id="estado_pais" class="form-control"  readonly>
                            </div>

                            <div>
                                <label for="">1s) Clave de su estado</label>
                                <p class="text-primary" style="font-size: 11px;">Campo autocompletado automáticamente.</p>
                                <input type="text" name="clave_estado" id="clave_estado" class="form-control" readonly>
                            </div>

                            <div>
                                <label for="">1t) Localidad (Información obtenida de los datos que registró en la plataforma <a target="_blank" href="<?= base_url() ?>">REDESLA</a>) </label>
                            ...
                            <div>
                                ...
                                <input type="text" name="clave_municipio" id="clave_municipio" class="form-control" readonly>
                            </div>
                            ...
                            <br>
                            <label for="">
                                1ae) Se realizó la equivalencia entre el catálogo de clasificación de los sectores empleada por la RELAYN y el Instituto Nacional de Estadística.
                            </label>

                            <input type="text" class="form-control" name="1r" id="1r" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="productos" id="selectProductos" class="form-control">
                                <div class="invalid-feedback">
                            ...
                            <table class="table text-center table-bordered table-responsive-lg" id="estratificacion">
                                ...
                                <thead class='thead-light'>
                                    <tr>
                                        ...
                                        <th>Rango de monto de ventas anuales (millones de pesos colombianos)</th>
                                        <th>Seleccione</th>
                                    </tr>
                                </thead>
                                <tbody>
