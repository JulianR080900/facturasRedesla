                    ...
                    <div class="col align-self-center">
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="1a" id="1a" class="form-control" required>
                            ...
                            <div>
                                ...
                                <select name="2a" id="2a" class="form-control" required>
                            ...
                            <div>
                                ...
                                <select name="3a" id="3a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <?php
                            ...
                            <div>
                                ...
                                <select name="4a" id="4a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                            ...
                            <div>
                                ...
                                <select name="5a" id="5a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Ciudad donde se ubica la universidad.">Ciudad donde se ubica la universidad.</option>
                                    <option value="Una comunidad pequeña cercana a esta ciudad.">Una comunidad pequeña cercana a esta ciudad.</option>
                                    <option value="Una ciudad vecina.">Una ciudad vecina.</option>
                                    <option value="Otra ciudad de este país.">Otra ciudad de este país.</option>
                            ...
                            <div>
                                ...
                                <select name="6a" id="6a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Caminando.">Caminando.</option>
                                    <option value="Utilizo coche.">Utilizo coche.</option>
                                    <option value="Utilizo mi moto.">Utilizo mi moto.</option>
                                    <option value="Utilizo servicio de taxi.">Utilizo servicio de taxi.</option>
                                    <option value="Me trae alguien de mi familia.">Me trae alguien de mi familia.</option>
                                    <option value="Utilizo el servicio de transporte público.">Utilizo el servicio de transporte público.</option>
                                    <option value="Utilizo el servicio de transporte proporcionado por mi institución.">Utilizo el servicio de transporte proporcionado por mi institución.</option>
                                    <option value="Utilizo el servicio de transporte público gratuito.">Utilizo el servicio de transporte público gratuito.</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="7a" id="7a" class="form-control" required hidden>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input type="number" id="7a_horas" class="form-control" required min='0' max='24'>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input type="number" id="7a_minutos" class="form-control" required min='0' max='59'>
                                            <div class="input-group-append">
                            ...
                            <div>
                                ...
                                <input type="text" name="8a" id="8a" class="form-control" required hidden>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input type="number" id="8a_horas" class="form-control" required min='0' max='24'>
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Horas</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input type="number" id="8a_minutos" class="form-control" required min='0' max='59'>
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">Minutos</span>
                                            </div>
                                        </div>
                            ...
                            <div>
                                ...
                                <select name="9a" id="9a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Sí">Sí</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <fieldset id="field2">
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="10a" id="0a" class="form-control" required>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="11a" id="11a" class="form-control" required>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="12a" id="12a" class="form-control" required>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="13a" id="13a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Con la familia en la que creciste.">Con la familia en la que creciste.</option>
                                    <option value="Acogido por parientes.">Acogido por parientes.</option>
                                    <option value="Acogido por amigos de la familia con la que creciste.">Acogido por amigos de la familia con la que creciste.</option>
                                    <option value="Con una familia formada por ti (i.e esposa e hijos)">Con una familia formada por ti (i.e esposa e hijos)</option>
                        ...
                        <fieldset id="field3">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_14a" value="14a" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_14a">
                                        En caso de que vaya por materia o avance libre.
                                    </label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="14b" id="14b" class="form-control" required>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="14c" id="14c" class="form-control" required>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="14d" id="14d" class="form-control" required>
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="14e" id="14e" class="form-control" required>
                            ...
                            <div>
                                ...
                                <input type="number" min='0' name="14f" id="14f" class="form-control" required>
                            ...
                            <div>
                                ...
                                <select name="14h" id="14h" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    ...
                                    <option value="Agronomía, pesca y veterinaria.">Agronomía, pesca y veterinaria.</option>
                                    <option value="Ciencias naturales, exactas o de la computación.">Ciencias naturales, exactas o de la computación.</option>
                                    <option value="Medicina o área de la salud.">Medicina o área de la salud.</option>
                                    <option value="Ciencias y Tecnologías de Información y Comunicación.">Ciencias y Tecnologías de Información y Comunicación.</option>
                            ...
                            <div>
                                ...
                                <select name="14i" id="14i" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Institución pública.">Institución pública</option>
                                    <option value="Institución privada.">Institución privada.</option>
                                    <option value="Institución técnica pública.">Institución técnica pública.</option>
                                    <option value="Institución técnica privada.">Institución técnica privada.</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="15b" id="15b" class="form-control" required readonly value="<?= $pais['nombre'] ?>">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="15c" id="15c" class="form-control" required readonly value="<?= $estado ?>">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="15a" id="15a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <?php
                            ...
                            <div>
                                ...
                                <input type="text" name="15d" id="15d" class="form-control" required readonly value="<?= $ca['inst_est'] ?>">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_15f" id="15f" value="15f" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_15f">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_15i" id="15i" value="15i" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_15i">
                                        No aplica cuenta de Twitter.
                                    </label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_15g" id="15g" value="15g" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_15g">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_15h" id="15h" value="15h" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_15h">
