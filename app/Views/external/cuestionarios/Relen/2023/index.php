...
<body>
                    ...
                    <div class="col align-self-center">
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <input type="number" class="form-control" name="1a" id="1a" required>
                            ...
                            <div>
                                ...
                                <input class="form-control" type="number" name="4a" id="4a" required min='0'>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="6a" id="6a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Titulado de escuela normal básica (cursada despues de la secundaria)">Titulado de escuela normal básica (cursada despues de la secundaria)</option>
                                    <option value="Titulado de escuela normal básica y al menos un año completo de educación superior.">Titulado de escuela normal básica y al menos un año completo de educación superior.</option>
                                    <option value="Titulado de escuela normal superior.">Titulado de escuela normal superior.</option>
                                    <option value="Titulado de otra licenciatura.">Titulado de otra licenciatura.</option>
                                    <option value="Al menos un año de maestría.">Al menos un año de maestría.</option>
                                    <option value="Título de maestría.">Título de maestría.</option>
                                    <option value="Título de doctorado.">Título de doctorado.</option>
                                    <option value="Título de escuela normal con licenciatura.">Título de escuela normal con licenciatura.</option>
                                </select>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div>
                                ...
                                <select class="form-control" name="7a" id="7a" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Escuela Normal pública.">Escuela Normal pública.</option>
                                    <option value="Escuela Normal privada.">Escuela Normal privada.</option>
                                    <option value="Universidad con carrera afín a la docencia.">Universidad con carrera afín a la docencia.</option>
                                    <option value="Universidad sin carrera afín a la docencia.">Universidad sin carrera afín a la docencia.</option>
                                </select>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div>
                                ...
                                <select class="form-control" name="8a" id="8a" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Doble plaza">Doble plaza</option>
                                    <option value="Plaza base">Plaza base</option>
                                    <option value="Interinato">Interinato</option>
                                    <option value="Tiempo completo">Tiempo completo</option>
                                    <option value="3/4 de tiempo">3/4 de tiempo</option>
                            ...
                            <div>
                                ...
                                <input type="number" name="9a" id="9a" class="form-control" required min='0'>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select class="form-control" name="11a" id="11a" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Escuela pública estatal.">Escuela pública estatal.</option>
                                    <option value="Escuela pública federal.">Escuela pública federal.</option>
                            ...
                            <div>
                                ...
                                <select class="form-control" name="12a" id="12a" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Urbano">Urbano</option>
                                    <option value="Urbano marginado">Urbano marginado</option>
                            ...
                            <div>
                                ...
                                <select name="14a" id="14a" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <?php
                                    foreach($especialidades as $e){
                                        ?>
                                        <option value="<?= $e['nombre'] ?>" <?= $ca['especialidad'] == $e['id'] ? 'selected':'' ?>><?= $e['nombre'] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="15a" id="15a" class="form-control" required min='0'>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="16a" id="16a" class="form-control" required min='0'>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="17a" id="17a" class="form-control" required min='0'>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="18a" id="18a" class="form-control" required>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="18c" id="18c" class="form-control" required readonly value="<?= $pais['nombre'] ?>">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="18d" id="18d" class="form-control" required readonly value="<?= $estado ?>">
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="18b" id="18b" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <?php
                            ...
                            <div>
                                ...
                                <p class="text-danger" id="aviso_especialidad">Si cambia la especialidad su encuesta no se tomará en cuenta, ya que ésta se encuentra asignada al grupo de investigación.</p>
                                <select name="18f" id="select_18f" class="form-control" required>
                                    <?php
                                    foreach($especialidades as $e){
                                        ?>
                                        <option value="<?= $e['nombre'] ?>" <?= $ca['especialidad'] == $e['id'] ? 'selected':'' ?>><?= $e['nombre'] ?></option>
                            ...
                            <p class="text-primary" style="font-size: 11px;">Ejemplo: https://www.facebook.com/RELEN.LA</p>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_18g" id="18g" value="18g" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_18g">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_18h" id="18h" value="18h" onchange="check_na(event);">
                                    <label class="form-check-label" for="check_18h">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_18i" id="18i" value="18i" onchange="check_na(event);" >
                                    <label class="form-check-label" for="check_18i">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="check_18j" id="18j" value="18j" onchange="check_na(event);" >
                                    <label class="form-check-label" for="check_18j">
    ...
    <script>
        ...
        var especialidad = '<?= $especialidad_ca ?>';
    </script>
