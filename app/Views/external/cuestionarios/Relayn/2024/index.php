...
<body>
          ...
          <form id="msform" method="post" action="../../agregar" class="needs-validation" novalidate data-toggle="validator">
            ...
            <fieldset id="field1">
              ...
              <div>
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="radioRFC" id="inlineRadio1" value="Si" required>
                  <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="radioRFC" id="inlineRadio2" value="NA" required>
              ...
              <div>
                <label for="">1x) Enlace de Google Maps con la ubicación física de la empresa.</label>
                <div class="pac-card" id="pac-card">
                  <div>
                    <div id="title">Geolocalización de mype</div>
                    <div id="type-selector" class="pac-controls">
                      ...
                      <label for="changetype-address">Calle</label>

                      <input type="radio" name="type" id="changetype-geocode" />
                      <label for="changetype-geocode">Geocódigo</label>
                    ...
                    <div id="strict-bounds-selector" class="pac-controls">
                      ...
                      <label for="use-strict-bounds">Modo estricto</label>
                    </div>
                  </div>
                  <div id="pac-container">
                    <input id="pac-input" type="text" placeholder="Ingrese la dirección de su mype" />
                  </div>
                </div>
                <div id="map"></div>
                ...
                <input type="text" name="coordenadas" id='coordenadas' required hidden>
                <div class="invalid-feedback">
                  Complete este campo.
                </div>
              </div>
              ...
              <div>
                ...
                <input type="number" class="form-control" name="2a" id="2a" min="1800" max="2024" required pattern="^[0-9]{4,}$">
              ...
              <h4>4) ¿Cuál es el nivel de estudios de sus trabajadores?</h3>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="" hidden>4a) Mujeres analfabetas (no sabe leer o escribir).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="" hidden>4a) Hombres analfabetas (no sabe leer o escribir).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                  <label for="" hidden>4b) Mujeres sin estudios (sabe leer y escribir, pero no tiene estudios).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                  <label for="" hidden>4b) Hombres sin estudios (sabe leer y escribir, pero no tiene estudios).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                  <label for="" hidden>4c) Mujeres con educación básica (preescolar, primaria, secundaria, formación para el trabajo).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                  <label for="" hidden>4c) Hombres con educación básica (preescolar, primaria, secundaria, formación para el trabajo).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="" hidden>4d) Mujeres con educación media superior (bachillerato general, bachillerato bivalente, profesional técnico).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                  <label for="" hidden>4d) Hombres con educación media superior (bachillerato general, bachillerato bivalente, profesional técnico).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="" hidden>4e) Mujeres con educación superior (licenciatura, ingeniería, especialidad, posgrado).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                  <label for="" hidden>4e) Hombres con educación superior (licenciatura, ingeniería, especialidad, posgrado).</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="" hidden>Total de personas que trabajan permanentemente en la empresa</label>
            ...
            <fieldset id="field2">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="" hidden>8a) ¿Cuántos días a la semana trabaja en la empresa?</label>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="" hidden>8b) ¿Cuántas horas promedio trabaja en la empresa por día?</label>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="" hidden>8c) ¿Cuenta con otro trabajo en alguna organización?</label>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="" hidden>8d) ¿Actualmente estudia, ya sea una carrera o cursos?</label>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="" hidden>8f) ¿Cuántas horas dedica al cuidado de otros miembros del hogar (hijos (as), esposo (a), padres u otros miembros) al día?</label>
              ...
              <table class="table table-striped table-responsive text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="9a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="9b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="9c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="9d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="9e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="10a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="10b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="10c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="10d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="10e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="11a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="11b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="11c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="11d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="11e" id="" value="5" required></td>
              ...
              <table class="table table-striped table-responsive text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="12a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="12b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="12c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="12d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="12e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="13a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="13b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="13c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="13d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="13e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="14a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="14b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="14c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="14d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="14e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="15a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="15b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="15c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="15d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="15e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="16a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="16b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="16c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="16d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="16e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="17a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="17b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="17c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="17d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="17e" id="" value="5" required></td>
            ...
            <fieldset id="field5">
              ...
              <table class="table table-striped table-responsive text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="18a" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="18b" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="18c" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="18d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="18e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="19e" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="20f" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="21d" id="" value="5" required></td>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="21e" id="" value="5" required></td>
              ...
              <input type="text" name="anio" id="" value="2024" hidden required>
  ...
  <script>
    ...
    let pais = '<?= $ca['pais'] ?>'
    var ubicacion = '<?= $municipio[0].', '.$estado.', '.$pais['nombre'] ?>'
  ...
  <script src="<?= base_url('/resources/js/investigaciones/Relayn/2024/index.js') ?>"></script>
