...
<body>
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <select name="1b" id="1b" class="form-control" required>
                                    ...
                                    <option value="Empresa constituida como empresa ( S.A, CIA LTDA, CIA en Nombre colectivo, CIA Encomandita).">Empresa constituida como empresa ( S.A, CIA LTDA, CIA en Nombre colectivo, CIA Encomandita).</option>
                                    <option value="Empresa con un dueño sin registro.">Empresa con un dueño sin registro.</option>
                                    <option value="Empresa con varios dueños sin RUC.">Empresa con varios dueños sin RUC.</option>
                                    <option value="Persona natural sin RUC ni RISE.">Persona natural sin RUC ni RISE.</option>
                                    <option value="Persona natural con RUC.">Persona natural con RUC.</option>
                                    <option value="Servicios profesionales (registrado).">Servicios profesionales (registrado).</option>
                                </select>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div id="rfcnit">
                                ...
                                ?>
                                    <div>
                                        <label for="">Escriba el RUC de la empresa.</label>
                                        <input type="number" class="form-control" name="nit" id="inputNIT" minlength="13" maxlength="13">
                                        <p id="valid_nit"></p>
                                        <div class="invalid-feedback">
                                            El RUC son 13 caracteres.
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div>
                                <label for="">1m) Tipo y nombre de las parroquias entre las que se ubica la empresa (para registrar las parroquias debe posicionarse dando la espalda a la
                            ...
                            <div>
                                ...
                                <select name="2e" id="2e" class="form-control" required>
                                    ...
                                    <option value="Clintes del cantón.">Clintes del cantón.</option>
    ...
    <script>
        ...
        let pais = '<?= $ca['pais'] ?>'
        if(pais != 2){
            const editables = ['clave_municipio','clave_estado','info_cp','otra_info_cp','localidad','clave_loc'];
    ...
    <script src="<?= base_url('resources/js/cuestionarios/Relayn/2023/Extranjeros.js') ?>"></script>
