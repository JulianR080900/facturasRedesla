...
<body>
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <select name="1b" id="1b" class="form-control" required>
                                    ...
                                    <option value="Está constituida como empresa (S.A., LTDA., S.A.S., etc.).">Está constituida como empresa (S.A., LTDA., S.A.S., etc.).</option>
                                    <option value="Empresa con un dueño sin registro en Cámara de Comercio o DIAN.">Empresa con un dueño sin registro en Cámara de Comercio o DIAN.</option>
                                    <option value="Empresa con varios dueños sin registro en Cámara de Comercio o DIAN.">Empresa con varios dueños sin registro en Cámara de Comercio o DIAN.</option>
                                    <option value="Persona natural con actividad empresarial.">Persona natural con actividad empresarial.</option>
                                    <option value="Régimen tributario especial.">Régimen tributario especial.</option>
                            ...
                            <div>
                                <label for="">1d) ¿La empresa cuenta con NIT (Número de Identificación Tributaria)?</label>
                                <br>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="inlineRadio2">No aplica NIT</label>
                                </div>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div id="rfcnit">
                                ...
                                ?>
                                    <div>
                                        ...
                                        <p class="text-primary" style="font-size: 11px;">El NIT consta de 9 a 10 dígitos. Después de los dígitos, se incluye un guión ("-") seguido de un número adicional.</p>
                                        <input type="text" class="form-control" name="nit" id="inputRIT" pattern="^\d{9,10}-(\d{1}|[kK])$">
                                        <p id="valid_nit"></p>
                                        <div class="invalid-feedback">
                            ...
                            <div>
                                ...
                                <select name="1i" id="1i" class="form-control" required>
                                    ...
                                    <option value="De comercio y servicios.">De comercio y servicios.</option>
                            ...
                            <div>
                                ...
                                <input type="number" name="clave_estado" id="clave_estado" class="form-control" readonly>
                            </div>
    ...
    <script>
        ...
        let pais = '<?= $ca['pais'] ?>'
        if(pais != 2){
            const editables = ['clave_municipio','clave_estado','info_cp','otra_info_cp','clave_localidad','nombre_localidad'];
