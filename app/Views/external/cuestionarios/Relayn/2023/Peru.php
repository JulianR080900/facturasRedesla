...
<body>
                        ...
                        <fieldset id="field1">
                            ...
                            <div>
                                ...
                                <select name="1b" id="1b" class="form-control" required>
                                    ...
                                    <option value="Está constituida como empresa (S.A., S.R., etc.).">Está constituida como empresa (S.A., S.R., etc.).</option>
                                    <option value="Empresa con dueño sin registro en SUNAT.">Empresa con dueño sin registro en SUNAT.</option>
                                    <option value="Empresa con varios dueños sin registro en SUNAT.">Empresa con varios dueños sin registro en SUNAT.</option>
                                    <option value="Persona física registrada en SUNAT.">Persona física registrada en SUNAT.</option>
                                    <option value="Régimen de incorporación fiscal.">Régimen de incorporación fiscal.</option>
                                    <option value="Servicios profesionales en SUNAT.">Servicios profesionales en SUNAT.</option>
                                </select>
                                <div class="invalid-feedback">
                                    Complete este campo.
                                </div>
                            ...
                            <div id="rfcnit">
                                ...
                                ?>
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="rfc" id="inputRFC" minlength="11" maxlength="11">
                                        <p id="valid_rfc"></p>
                                        <div class="invalid-feedback">
                                ...
                                ?>
                                    <div>
                                        <label for="">Escriba el SUNAT de la empresa.</label>
                                        <input type="number" class="form-control" name="nit" id="inputNIT" minlength="11" maxlength="11">
                                        <p id="valid_nit"></p>
                                        <div class="invalid-feedback">
                                            El SUNAT son al menos 13 catácteres.
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="tel_fijo" required id="tel_fijo" class="form-control" minlength="11" maxlength="11" placeholder="Ejemplo: +5112345678">
                                        <div class="form-check">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="tel_cel" required id="tel_cel" class="form-control" minlength="11" maxlength="11" placeholder="Ejemplo: +5112345678">
                                        <div class="form-check">
                            ...
                            <div hidden>
                                ...
                                <input type="text" class="form-control" name="1g" id="1g" required value="S/N">
                                <div class="form-check">
                            ...
                            <div>
                                <label for="">1m) Tipo y nombre de las vialidads entre las que se ubica la empresa (para registrar las vialidades debe posicionarse dando la espalda a la
                            ...
                            <div id="otro_piso">
                                <label for="">Especifique</label>
                                <input type="text" name="otro_piso" id="otro_piso_input" class="form-control" value="No aplica para el país registrado">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="clave_estado" id="clave_estado" class="form-control" readonly value="No aplica para el país registrado">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="clave_municipio" id="clave_municipio" class="form-control" readonly value="No aplica para el país registrado">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="clave_localidad" id="clave_localidad" class="form-control" readonly>
                            </div>
                            ...
                            <div>
                                ...
                                <label for="">Seleccione una Actividad Económica (Sección):</label>
                            ...
                            <div>
                                <label for="">Seleccione una Actividad Económica (División):</label>
                            ...
                            <div>
                                <label for="">Seleccione una Actividad Económica (Grupo):</label>
                            ...
                            <div>
                                <label for="">Seleccione una Actividad Económica (Clase):</label>
                            ...
                            <div>
                                ...
                                <select name="2e" id="2e" class="form-control" required>
                                    <option value="" selected disabled>Seleccione una opción</option>
                                    <option value="Clientes del barrio.">Clientes del barrio.</option>
                                    <option value="Clintes del cantón.">Clintes del distrito.</option>
                                    <option value="Clientes de la provincia.">Clientes de la provincia.</option>
                                    <option value="Clientes del país.">Clientes del país.</option>
                                    <option value="Clientes del extranjero.">Clientes del extranjero.</option>
                                    <option value="Ventas a otras empresas.">Ventas a otras empresas.</option>
                                    <option value="Ventas al gobierno.">Ventas al gobierno.</option>
                                </select>
    ...
    <script>
        ...
        let pais = '<?= $ca['pais'] ?>'
        if (pais != 2) {
            const editables = ['clave_municipio', 'clave_estado', 'info_cp', 'otra_info_cp', 'nombre_localidad', 'clave_localidad'];
    ...
    <script src="<?= base_url('resources/js/cuestionarios/Relayn/2023/Peru.js') ?>"></script>
