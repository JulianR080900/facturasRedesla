...
<head>
    ...
    <title>Información de la investigación <?= $red.' '.$anio ?></title>
</head>
<body>
    <div class="container">
    <section>
        <div class="row col-auto text-center" id="row_imagenes">
            <img src="<?php echo base_url("resources/img/logos_con_letras/Letras_".$red.".png"); ?>" width="50%" alt="Constancias Redesla" >
            <hr>
            <h3>Información de la</h3>
            <h1>INVESTIGACIÓN <?= strtoupper($red) ?> <?= $anio ?></h1>
        </div>
    </section>
    <section>
            ...
            <div class="row">
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5>Cantidad de equipos registrados</h5>
                    <div class="row">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5>Cantidad de encuestas válidad</h5>
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
