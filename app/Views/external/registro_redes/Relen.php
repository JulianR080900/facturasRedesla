...
<head>
    ...
    <title>REGISTRO RELEN</title>

    <link rel="stylesheet" href="<?= base_url("resources/css/registro/Relen.css") ?>">
...
<body>
    ...
    <form class="g-3 needs-validation" action="<?= base_url("insertarRegistroRelen") ?>" method="post" novalidate>
        <!--g-3 needs-validation <-- ponerlo en la clase-->

        <section class="text-center">

            <img src="<?= base_url("resources/img/logos_con_letras/Letras_Relen.png"); ?>" width="40%" alt="">

            <hr>

            <h1>REGISTRO A RELEN</h1>
        ...
        <section id="datos_universidad">
            ...
            <div id="informacion_general">
                ...
                <div class="mb-3" style="display:none" id="divotropais">
                    ...
                    <input type="text" class="form-control ln" id="otropais" name="cbx_pais" placeholder="Nombre del país">
                ...
                <div class="mb-3" style="display:none" id="divotroestado">
                    ...
                    <input type="text" class="form-control ln" id="otroestado" name="cbx_estado" placeholder="Nombre del estado">
                ...
                <div class="mb-3" style="display:none" id="divotromunicipio">
                    ...
                    <input type="text" class="form-control ln" id="otromunicipio" name="cbx_municipio" placeholder="Nombre del municipio">
            ...
            <div class="mb-3" id="inst_universidad">
                ...
                <label for="inst_est">Institución/Universidad en la que se aplicará el estudio: </label>

                <input type="text" class="form-control ln" id="inst_est" name="inst_est" placeholder="Institución/Universidad en la que se aplicará el estudio: ">

                <div class="invalid-feedback">

                    Ingresa la Institución/Universidad en la que se aplicará el estudio: .
            ...
            <div class="mb-3" id="especialidad">

                <label for="inst_est">Especialidad</label>

                <select class="form-control" name="especialidad" id="especialidad">

                    <option value="" selected="true" readonly>Selecciona tu especialidad</option>

                    <?php

                    foreach ($especialidades as $ga) {
            ...
            <button type="button" id="siguiente_miembros" class="btn btn-block" style="background-color: #a91f24; color: white;">Siguiente</button>
        ...
        <section id="cantidad_miembros">
            ...
            <input type="hidden" name="redCueCa" value="Relen">

            <button type="button" id="siguiente_datos" class="btn btn-block" style="background-color: #a91f24; color: white;">Siguiente</button>

            <button type="button" id="regresar_universidad" class="btn btn-block" style="background-color: #a91f24; color: white;">Anterior</button>
        ...
        <section id="datos_miembros">
            ...
            <button type="submit" class="btn btn-block" style="background-color: #a91f24; color: white;" id="btnTerminarRegistro">Terminar registro</button>

            <button type="button" id="regresar_cantidad" class="btn btn-block" style="background-color: #a91f24; color: white;">Anterior</button>
    ...
    <script src="<?= base_url("resources/js/registro/Relen/index.js") ?>"></script>
