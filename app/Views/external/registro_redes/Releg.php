...
<head>
    ...
    <title>REGISTRO RELEG</title>

    <link rel="stylesheet" href="<?= base_url("resources/css/registro/Releg.css") ?>">
...
<body>
    ...
    <form class="g-3 needs-validation" action="<?= base_url("insertarRegistroReleg") ?>" method="post" novalidate>
        <!--g-3 needs-validation <-- ponerlo en la clase-->

        <section class="text-center">

            <img src="<?= base_url("resources/img/logos_con_letras/Letras_Releg.png"); ?>" width="40%" alt="">

            <hr>

            <h1>REGISTRO A RELEG</h1>
        ...
        <section id="datos_universidad">
            ...
            <div id="informacion_general">
                ...
                <div class="mb-3" id="inst_universidad">
                    ...
                    <div class="invalid-feedback">
                        ...
                        Ingresa su institución/universidad en la que se aplicará el estudio.
            ...
            <div id="numeros_universidad">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="telefonoUniversidad" name="telefonoUniversidad" placeholder="No. teléfono" required>
            ...
            <button type="button" id="siguiente_miembros" class="btn btn-block" style="background-color: #e95296; color: white;">Siguiente</button>
        ...
        <section id="cantidad_miembros">
            ...
            <input type="hidden" name="redCueCa" value="Releg">

            <button type="button" id="siguiente_datos" class="btn btn-block" style="background-color: #e95296; color: white;">Siguiente</button>

            <button type="button" id="regresar_universidad" class="btn btn-block" style="background-color: #e95296; color: white;">Anterior</button>
        ...
        <section id="datos_miembros">
            ...
            <button type="submit" class="btn btn-block" style="background-color: #e95296; color: white;" id="btnTerminarRegistro">Terminar registro</button>

            <button type="button" id="regresar_cantidad" class="btn btn-block" style="background-color: #e95296; color: white;">Anterior</button>
    ...
    <script src="<?= base_url("resources/js/registro/Releg/index.js") ?>"></script>
