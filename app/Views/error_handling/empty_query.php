...
<div class="notfound-copy">
  <svg aria-labelledby="404" alt="404 Registros no encontrados" class="not-found">
  <title id="svgtitle1">404 Registros de <?= $tabla ?> no encontrados</title>
  <g class="404-text">
  ...
  <h1>Registros de <?= $tabla ?> no encontrados</h1>
