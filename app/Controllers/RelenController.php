...
class RelenController extends ExternalController
{
    ...
    public function insertarRegistro(){
        ...
        if ($this->ExternalModel->generalInsertSession("cuerpos_academicos", $data_institucion)) {
            ...
            if($count_miembros == $inserciones){
                ...
                $condiciones_inv = array("red"=> "Relen","anio"=>$anio); //Esto se tiene que cambiar con cada año
                ...
                Por medio de la presente reciba un cordial saludo cada uno de los miembros del nuevo grupo <span style='color:#8A171E'>$clave</span>, 

                le confirmamos su participación para colaborar y ser parte de la 

                <span style='color:#8A171E'>Red de Estudios Latinoamericanos en Educación Normal RELEN</span>.
                ...
                <img src='https://redesla.la/redesla/resources/img/firmas/Relen.jpeg' />
                ...
                foreach($_POST["miembros"] as $m){
                    ...
                    $email->setFrom('atencion@redesla.la', 'Registro RELEN');
                    $email->setTo($m["correo_personal"]);
                    $email->setSubject('¡Bienvenidos a RELEN!');
                ...
                switch($_POST["tipo_registro"]){
                    ...
                    case 'investigación':
                        ...
                        . strtoupper("Relen")."</b>, con el fin de confirmar su participación y colaborar la 
                        ...
                        <ul>
                            ...
                            <li>Especialidad: ".$_POST["especialidad"]."</li>
                        ...
                        <img src='https://redesla.net/redesla/resources/img/firmas/Relen.jpeg' />
                        ...
                        foreach($_POST["miembros"] as $m){
                            ...
                            $mail->setFrom("atencion@redesla.net", 'Registro RELEN');

                            $mail->addAddress($m["correo_personal"]);

                            $mail->CharSet = 'UTF-8';

                            $mail->Subject = "¡Bienvenido a RELEN!";
                    ...
                    case 'congreso':
                        ...
                        <img src="https://redesla.net/redesla/resources/img/attachments_correos/Mailing Congreso RELEN.jpg" />

                        <p>

                        Apreciable investigador (a) '.$primer_autor.'

                        </p>

                        <p>

                        Le confirmamos que ya contamos con su solicitud para ser parte del "<b>3er. Congreso 

                        Latinoamericano de Investigación en Educación Normal. RELEN 2022</b>". 
                        ...
                        <b>RELEN</b>, llevarán a cabo la organización de este congreso de investigación, los días <b>02 
                        ...
                        <a href="https://iquatroeditores.com/revista/index.php/iquatro/user/register" target="_blank">iQuatro Editores</a> e iniciar sesión realizando el siguiente proceso: </b>
                        ...
                        2.1. Revise que cumpla con todos los <b><a href="https://iquatroeditores.com/revista/index.php/iquatro/about/submissions" target="_blank">requisitos</a></b>, antes de proceder con el envío de 
                        ...
                        respetando la "<a href="https://drive.google.com/file/d/1iOzhEgH26MRcpMkh6KPrURB_f1BTk1C4/view" target="_blank">convocatoria</a>" y el nivel (categoría) con el que participará, 

                        mismo que contiene los parámetros mencionados en el apartado <b>I. Formato de la 

                        <a href="https://drive.google.com/file/d/1iOzhEgH26MRcpMkh6KPrURB_f1BTk1C4/view" target="_blank">convocatoria</a></b>.
                        ...
                        rechazada la presentación de la ponencia en el <b>3er. Congreso Latinoamericano de 

                        Investigación en Educación Normal. RELEN 2022.</b>. Se notificará dicho dictamen 
                        ...
                        <a href="https://iquatroeditores.com/revista/index.php/relep/index" target="_blank">Revista RELEP</a> o como capítulo en el <a href="https://relen.la/biblioteca/" target="_blank">libro electrónico</a> del "<b>>3er. Congreso 
                        ...
                        <b>Una vez aceptada su ponencia: </b>
                        ...
                        inscripción</b>: $6,430.00 (seis mil cuatrocientos treinta pesos 00/100 MXN) IVA incluido 

                        por ponencia, para los participantes fuera de México será de: 332 USD (trescientos 

                        treinta y dos dólares 00/100 USD) IVA incluido por ponencia, esta puede ser de uno 

                        a máximo cuatro autores. <br>

                        Puede aprovechar los <b>descuentos de pronto pago</b> realizando el mismo a más tardar el 15 

                        de octubre del 2022, con la <b>tarifa de inscripción con descuento</b>: $6,030.00 (seis mil 

                        treita pesos 00/100 MXN) IVA incluido por ponencia, para los participantes fuera de 

                        México será de 307 USD: (trescientos siete dólares 00/100 USD) IVA incluido por 

                        ponencia, esta puede ser de uno a máximo cuatro autores. 
                        ...
                        Recuerde colocar el en concepto su ID del artículo-Congreso RELEN.
                        ...
                        lo invitamos a darle "like" a nuestra página de Facebook para estar actualizado de 

                        todas las actividades a realizar: <br>

                        <a href="https://www.facebook.com/RELEN.LA" target="_blank>https://www.facebook.com/RELEN.LA</a>
                        ...
                        correspondiente y asistiendo a las actividades de nuestro <b>3er. Congreso Latinoamericano 

                        de Investigación en Educación Normal. RELEN 2022.</b><br>
                        ...
                        Correo: relen@redesla.net, contacto@relen.la  <br>

                        WhatsApp: +52 1 5537986840 <br>

                        Teléfonos: 4425039607, 4271389926  

                        </p>

                        <p>

                        <img src="https://redesla.net/redesla/resources/img/firmas/Atencion_Relen.jpg" />
                        ...
                        foreach($_POST["miembros"] as $m){
                            ...
                            $mail->setFrom("atencion@redesla.net", 'Registro a Congreso Relen '. date("Y"));

                            $mail->addAddress($m["correo_personal"]);

                            $mail->CharSet = 'UTF-8';

                            $mail->Subject = "Confirmación de inscripción como ponentes del 3er. Congreso Latinoamericano de Investigación en Educación Normal. RELEN 2022";

                            $mail->Body = $html;

                            $mail->addStringAttachment(file_get_contents(base_url("resources/img/attachments_correos/Cartel_General_RELEN_22.jpg")), 'Cartel_General_RELEN_22.jpg');
                    ...
                    //<b><span style="color:#93181d"></span></b>
                    ...
                    <p>
                        ...
                        "<b><span style="color:#93181d">3er. Congreso Latinoamericano de Investigación en Educación Normal. RELEN 2022</span></b>". 

                    </p>

                    <p>

                        Dicho evento se llevará a cabo bajo <b>modalidad mixta</b>, siendo de <b>manera virtual</b> dentro de nuestro espacio 

                        "<b>Vive RedesLA</b>" y de <b>forma física</b> en las instalaciones de nuestra institución anfitriona: la 

                        <b>Universidad Latina de América en Morelia, Michoacán</b>, quienes en conjunto con 

                        <b>Redes de Estudios Latinoamericanos (REDESLA)</b> a quien pertenece <b><span style="color:#93181d">RELEN</span></b>, llevarán a cabo la organización 

                        de este congreso de investigación, los días <b>02 y 03 de diciembre del 2022</b>. 
                    ...
                    <p>
                        ...
                        Para continuar con su participación deberá hacer el "<b>Pago de su participación</b>" a más tardar el 21 de noviembre del 

                        presente año de: $1,130.00 (mil ciento treinta pesos 00/100 MXN) IVA incluido por asistente, para los participantes 

                        fuera de México será de: 57 USD (cincuenta y seis dólares 00/100 USD) IVA incluido por asistente.

                    </p>

                    <p>

                        Puede aprovechar los <b>descuentos de pronto pago</b> realizando el mismo a más tardar el 15 de octubre del 2022, 

                        con la <b>tarifa de inscripción con descuento</b>: $985 (novecientos ochenta y cinco pesos 00/100 MXN) IVA incluido 

                        por asistente, para los participantes fuera de México será de 49 USD: (cuarenta y nueve dólares 00/100 USD) 
                    ...
                    <p>
                        ...
                        pueden pagar desde esta liga de pago en línea que le permitirá pagar de forma directa, OXXO y tiendas 

                        de conveniencia: <a href="https://link.mercadopago.com.mx/sdmypesredesla">https://link.mercadopago.com.mx/sdmypesredesla</a> 

                    </p>

                    <p>

                        Los participantes de cualquier país ajeno a México recibirán la solicitud de pago mediante una <a href="https://www.paypal.com/mx/webapps/mpp/country-worldwide">plataforma online</a> 

                        a sus correos electrónicos y podrán realizarlo vía internet de acuerdo a las políticas de sus bancos, o bien 

                        podrá ejecutarlo desde este link: <a href="https://paypal.me/paqueteb1?locale.x=es_XC">https://paypal.me/paqueteb1?locale.x=es_XC</a>.  

                    </p>

                    <p>

                        Recuerde colocar el en concepto su nombre-Congreso RELEN.
                    ...
                    <p>
                        ...
                        <a href="https://www.facebook.com/RELEN.LA">https://www.facebook.com/RELEN.LA</a>

                    </p>

                    <p>

                        Esperamos verlos y contar con su presencia física o virtual, asistiendo a las actividades de nuestro 

                        <b><span style="color:#93181d">3er. Congreso Latinoamericano de Investigación en Educación Normal. RELEN 2022</span></b>.<br>

                        <b><span style="color:#93181d">#</span>Pasión<span style="color:#93181d">Por</span>La<span style="color:#93181d">Investigación</span></b> 
                    ...
                    <p>
                        ...
                        WhatsApp: <a href="https://api.whatsapp.com/send?phone=5215537986840&text=%F0%9F%93%91%20Hola%2C%20me%20interesa%20recibir%20informaci%C3%B3n%20del%20*Congreso%20Latinoamericano%20de%20Investigaci%C3%B3n%20RELEN*%20sobre...%0AMi%20nombre%20es...%20Mi%20correo%20es...">+52 1 5537986840</a> <br>
                    ...
                    foreach($_POST["miembros"] as $m){
                        ...
                        $mail->setFrom("atencion@redesla.net", 'Confirmación de inscripción como oyente del 3ero. Congreso Latinoamericano de Investigación en Educación Normal, RELEN 2022');

                        $mail->addAddress($m["correo_personal"]);

                        $mail->CharSet = 'UTF-8';

                        $mail->Subject = "Confirmación de inscripción como oyente del 3ero. Congreso Latinoamericano de Investigación en Educación Normal, RELEN 2022";
